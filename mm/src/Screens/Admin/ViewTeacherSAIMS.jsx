...
function ViewTeacherSAIMS(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewTeacherSAIMS('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewTeacherSAIMS('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewTeacherSAIMS('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherSAIMS('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewTeacherSAIMS('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewTeacherSAIMS('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherSAIMS('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherSAIMS('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherSAIMS('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="SAIMS Teachers's Details"/>
