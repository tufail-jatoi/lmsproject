...
function ViewStudentDow(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewStudentDow('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewStudentDow('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewStudentDow('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentDow('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewStudentDow('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewStudentDow('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentDow('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentDow('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentDow('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="Dow Student's Details"/>
