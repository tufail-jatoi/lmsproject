...
function ViewTeacherDow(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewTeacherDow('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewTeacherDow('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewTeacherDow('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherDow('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewTeacherDow('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewTeacherDow('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherDow('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherDow('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherDow('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];
