...
function ViewTeacherKU(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewTeacherKU('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewTeacherKU('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewTeacherKU('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherKU('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewTeacherKU('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewTeacherKU('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherKU('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherKU('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewTeacherKU('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="KU Teacher's Details"/>
