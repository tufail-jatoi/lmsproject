...
function ViewStudentKU(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewStudentKU('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewStudentKU('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewStudentKU('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentKU('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewStudentKU('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewStudentKU('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentKU('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentKU('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentKU('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="KU Student's Details"/>
