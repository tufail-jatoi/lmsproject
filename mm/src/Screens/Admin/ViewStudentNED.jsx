...
function ViewStudentNED(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewStudentNED('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewStudentNED('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewStudentNED('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentNED('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewStudentNED('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewStudentNED('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentNED('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentNED('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentNED('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="NED Student's Details"/>
