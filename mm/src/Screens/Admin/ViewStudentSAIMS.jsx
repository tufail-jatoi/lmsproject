...
function ViewStudentSAIMS(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViewStudentSAIMS('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViewStudentSAIMS('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViewStudentSAIMS('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentSAIMS('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViewStudentSAIMS('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViewStudentSAIMS('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentSAIMS('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentSAIMS('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViewStudentSAIMS('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="SAIMS Student's Details"/>
