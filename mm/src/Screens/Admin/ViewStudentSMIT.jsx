...
function ViwqStudentSMIT(name, calories, fat, carbs, protein, price) {
  return {
    name,
    calories,
    fat,
...
const rows = [
  ...
  ViwqStudentSMIT('Michael Johnson', "Pakistan", "Karachi", +92321212121, "Male",  ),
  ViwqStudentSMIT('Omar Hassan', "Pakistan", "Karachi", +92321212121, "Male",),
  ViwqStudentSMIT('Ali Mahmood',"Pakistan", "Karachi", +92321212121, "Male", ),
  ViwqStudentSMIT('Maria Rodriguez', "Pakistan", "Karachi", +92321212121, "Female", ),
  ViwqStudentSMIT('Fatima Khan', "Pakistan", "Karachi", +92321212121, "Female",),
  ViwqStudentSMIT('Ali Ahmed', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViwqStudentSMIT('Juan Martinez', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViwqStudentSMIT('Jhon Adam', "Pakistan", "Karachi", +92321212121, "Male", ),
  ViwqStudentSMIT('Sarah Anderson', "Pakistan", "Karachi", +92321212121, "Female", ),
];

export default function CollapsibleTable() {
  return (
    <>
     <BAScreenHeader screenTitle="SMIT Student's Details"/>
